    ...
    run: async (client, interaction, args) => {
        ...
        Schema.findOne({ User: user.id }, async (err, data) => {
            if (data) {
                ...
                return client.errNormal({ error: "Aucun profil trouvé ! Créez un profil avec /profile create", type: 'ephemeral' }, interaction);
            }
        })
    },
};