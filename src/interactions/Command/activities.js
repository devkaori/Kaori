...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option =>
            option.setName('activity')
                .setDescription('L\'activité que vous souhaitez')
                .setRequired(true)
                .addChoices(
                    { name: 'Betrayal.io', value: 'betrayal' },
                    { name: 'Dames au parc', value: 'checkers' },
                    { name: 'Échecs au parc', value: 'chess' },
    ...
    run: async (client, interaction, args) => {
        ...
        if (activity == "betrayal") {
            ...
            client.generateActivity("832013003968348200", "Dames au parc", channel, interaction)
        }
        else if (activity == "chess") {
            client.generateActivity("832012586023256104", "Échecs au parc", channel, interaction)
        }
            ...
            client.generateActivity("755827207812677713", "Soirée Poker", channel, interaction)
        }
            ...
            client.generateActivity("880218394199220334", "Regarder ensemble", channel, interaction)
        }
