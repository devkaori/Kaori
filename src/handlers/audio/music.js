        ...
        if (interaction.isButton()) {
            if (interaction.customId == "Bot-musicpause") {
                ...
                client.embed({
                    ...
                    url: embedData.url,
                    desc: `La musique est actuellement en pause`,
            ...
            if (interaction.customId == "Bot-musicstart") {
                ...
                client.embed({
                    title: embedData.title,
                    url: embedData.url,
                    desc: `La musique est actuellement reprise`,
                    thumbnail: embedData.thumbnail.url,
                    fields: embedData.fields,
                    components: [row],
                    type: 'edit'
            ...
            if (interaction.customId == "Bot-musicstop") {
                ...
                client.embed({
                    desc: `La musique est actuellement arrêtée`,
                    color: client.config.colors.error,
                    components: [],
                    type: 'edit'
                }, interaction.message)
            ...
            if (interaction.customId == "Bot-musicnext") {
                ...
                client.embed({
                    title: `${track.title}`,
                    url: track.uri,
                    desc: `La musique a démarré dans le salon <#${player.voiceChannel}> !`,
            ...
            if (interaction.customId == "Bot-musicprev") {
                ...
                client.embed({
                    ...
                    fields: [
                        ...
                        {
                            name: `${client.emotes.normal.clock}┆Se termine à`,
                            value: `<t:${((Date.now() / 1000) + (track.duration / 1000)).toFixed(0)}:f>`,
                            inline: true
                        },
                        {
